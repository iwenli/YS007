...
namespace Ys.Sdk.Demo.Core.Entities
{
	...
	public class YsError
	{
		...
		/// EZPCOpenSDK Error
		/// </summary>
		public static Dictionary<string, string> MessageErrorDictionary { get; set; }

		/// <summary>
		/// 预览,回放消息回调ErrorCode具体错误码值
		/// EZPCOpenSDK Error
		/// </summary>
		public static Dictionary<uint, string> CodeErrorDictionary { get; set; }
		...
		static YsError()
		{
			...
			MessageErrorDictionary = new Dictionary<string, string>();
			MessageErrorDictionary.Add("UE001", "accesstoken异常或失效，需要重新获取accesstoken，并传入到sdk");
			MessageErrorDictionary.Add("UE002", "appkey和AccessToken不匹配,建议更换appkey或者AccessToken");
			MessageErrorDictionary.Add("UE004", "通道不存在，设备参数错误，建议重新获取播放地址");
			MessageErrorDictionary.Add("UE005", "设备不存在，设备参数错误，建议重新获取播放地址");
			MessageErrorDictionary.Add("UE006", "参数错误，建议重新获取播放地址");
			MessageErrorDictionary.Add("UE007", "播放地址错误,建议重新获取播放地址");
			MessageErrorDictionary.Add("UE101", "设备连接数过大，停止其他连接后再试试吧");
			MessageErrorDictionary.Add("UE102", "设备不在线，确认设备上线之后重试");
			MessageErrorDictionary.Add("UE103", "播放失败，请求连接设备超时，检测设备网路连接是否正常");
			MessageErrorDictionary.Add("UE104", "视频验证码错误，建议重新获取url地址增加验证码");
			MessageErrorDictionary.Add("UE105", "视频播放失败, 请查看具体的ErrorCode");
			MessageErrorDictionary.Add("UE106", "当前账号开启了终端绑定，只允许指定设备登录操作");
			MessageErrorDictionary.Add("UE107", "设备信息异常为空，建议重新获取播放地址");
			MessageErrorDictionary.Add("UE108", "未查找到录像文件");
			MessageErrorDictionary.Add("UE109", "取流并发路数限制,请升级为企业版");
			MessageErrorDictionary.Add("UE110", "设备不支持的清晰度类型, 请根据设备预览能力级选择");
			#endregion

			#region ErrorCodeErrorDictionary
			CodeErrorDictionary = new Dictionary<uint, string>();
			CodeErrorDictionary.Add(2001, "获取操作码失败");
			CodeErrorDictionary.Add(2002, "获取取流token失败");
			CodeErrorDictionary.Add(2003, "设置语音采集回调播放失败");
			CodeErrorDictionary.Add(2004, "开启语音播放失败");
			CodeErrorDictionary.Add(2005, "语音采集开启播放失败");
			CodeErrorDictionary.Add(2006, "tts TALK_VTDU CreateTalk error");
			CodeErrorDictionary.Add(2007, "tts TALK_VTDU SetDataCallBack error");
			CodeErrorDictionary.Add(2008, "tts TALK_VTDU SetMsgCallBack error");
			CodeErrorDictionary.Add(2009, "tts TALK_VTDU StartTalk error");
			CodeErrorDictionary.Add(2010, "cas TALK_TCP/ TALK_UDP CreateSession error");
			CodeErrorDictionary.Add(2011, "cas TALK_TCP/ TALK_UDP VoiceTalkStart error");
			CodeErrorDictionary.Add(2012, "重新输入密钥 1.明文密钥和输入MD5密钥不相等");
			CodeErrorDictionary.Add(2013, "VTDU返回的操作码错误或信令密钥错误");
			CodeErrorDictionary.Add(2014, "停止语音采集失败");
			CodeErrorDictionary.Add(2015, "停止语音播放失败");
			CodeErrorDictionary.Add(2016, "停止语音采集成功");
			CodeErrorDictionary.Add(2017, "停止语音播放成功");
			CodeErrorDictionary.Add(2021, "流媒体向设备发送或接受信令超时");
			CodeErrorDictionary.Add(2022, "验证token失败");
			CodeErrorDictionary.Add(2023, "客户端的URL格式错误");
			CodeErrorDictionary.Add(2025, "vtdu客户端接收回应超时");
			CodeErrorDictionary.Add(2026, "取流session出错");
			CodeErrorDictionary.Add(2027, "等待流头超时");
			CodeErrorDictionary.Add(2028, "用户停止");
			CodeErrorDictionary.Add(2029, "解密失败");
			CodeErrorDictionary.Add(2031, "vtdu取流创建session失败");
			CodeErrorDictionary.Add(2032, "vtdu取流销毁session失败");
			CodeErrorDictionary.Add(2033, "vtdu取流开始失败，返回-1时设置");
			CodeErrorDictionary.Add(2034, "vtdu取流停止失败");
			CodeErrorDictionary.Add(2035, "vtdu取流暂停失败");
			CodeErrorDictionary.Add(2036, "vtdu取流恢复失败");
			CodeErrorDictionary.Add(2037, "vtdu取流改变速率失败");
			CodeErrorDictionary.Add(2044, "VTDUtoken无权限");
			CodeErrorDictionary.Add(2045, "VTDUsession不存在");
			CodeErrorDictionary.Add(2046, "VTDU验证token的他异常（不具体）");
			CodeErrorDictionary.Add(2047, "VTDU客户端连接不上VTM");
			CodeErrorDictionary.Add(2048, "VTDU客户端连接不上VTDU");
			CodeErrorDictionary.Add(2049, "设备通道错误");
			CodeErrorDictionary.Add(2050, "设备不支持的码流类型");
			CodeErrorDictionary.Add(2051, "设备连接不上流媒体");
			CodeErrorDictionary.Add(2052, "客户端给的cas地址信息错误");
			CodeErrorDictionary.Add(2053, "视频分享时间已经结束");
			CodeErrorDictionary.Add(2054, "流媒体接收流头超时8s");
			CodeErrorDictionary.Add(2055, "VtduiParamTypeerror");
			CodeErrorDictionary.Add(2056, "获取操作码参数错误");
			CodeErrorDictionary.Add(2057, "无法找到设备");
			CodeErrorDictionary.Add(2058, "获取Token参数错误");
			CodeErrorDictionary.Add(2059, "获取的Token为空");
			CodeErrorDictionary.Add(2060, "找不到可用文件");
			...
			CodeErrorDictionary.Add(2201, "通用错误返回");
			CodeErrorDictionary.Add(2202, "入参为空指针");
			CodeErrorDictionary.Add(2203, "入参值无效");
			CodeErrorDictionary.Add(2204, "信令消息解析非法");
			CodeErrorDictionary.Add(2205, "内存资源不足");
			CodeErrorDictionary.Add(2206, "协议格式不对或者消息体长度超过STREAM_MAX_MSGBODY_LEN");
			CodeErrorDictionary.Add(2207, "设备序列号长度不合法");
			CodeErrorDictionary.Add(2208, "取流url长度不合法");
			CodeErrorDictionary.Add(2209, "解析vtm返回vtdu地址不合法");
			CodeErrorDictionary.Add(2210, "解析vtm返回级联vtdu地址不合法");
			CodeErrorDictionary.Add(2211, "解析vtm返回会话标识长度不合法");
			CodeErrorDictionary.Add(2212, "vtdu返回流头长度不合法");
			CodeErrorDictionary.Add(2213, "vtdu会话长度非法");
			CodeErrorDictionary.Add(2214, "回调函数未注册");
			CodeErrorDictionary.Add(2215, "vtdu成功响应未携带会话标识");
			CodeErrorDictionary.Add(2216, "vtdu成功响应未携带流头");
			CodeErrorDictionary.Add(2217, "无数据流，尚未使用");
			CodeErrorDictionary.Add(2218, "信令消息体PB解析失败");
			CodeErrorDictionary.Add(2219, "信令消息体PB封装失败");
			CodeErrorDictionary.Add(2220, "申请系统内存资源失败");
			CodeErrorDictionary.Add(2221, "vtdu地址尚未获取到");
			CodeErrorDictionary.Add(2222, "客户端尚未支持");
			CodeErrorDictionary.Add(2223, "获取系统socket资源失败");
			CodeErrorDictionary.Add(2224, "上层填充的StreamSsnId不匹配");
			CodeErrorDictionary.Add(2225, "链接服务器失败");
			CodeErrorDictionary.Add(2226, "客户端请求未收到服务端应答");
			CodeErrorDictionary.Add(2227, "链路断开");
			CodeErrorDictionary.Add(2228, "没有取流链接");
			CodeErrorDictionary.Add(2229, "流成功停止");
			CodeErrorDictionary.Add(2230, "客户端防串流校验失败");
			CodeErrorDictionary.Add(2231, "应用层tcp粘包处理缓冲区满");
			CodeErrorDictionary.Add(2232, "无效状态迁移");
			CodeErrorDictionary.Add(2233, "无效客户端状态");
			CodeErrorDictionary.Add(2234, "向vtm取流流媒体信息请求超时");
			CodeErrorDictionary.Add(2235, "向代理取流请求超时");
			CodeErrorDictionary.Add(2236, "向代理保活取流请求超时");
			CodeErrorDictionary.Add(2237, "向vtdu取流请求超时");
			CodeErrorDictionary.Add(2238, "向vtdu保活取流请求超时");
			CodeErrorDictionary.Add(2602, "回放在不到录像文件");
			CodeErrorDictionary.Add(2603, "操作码或信令密钥与设备不匹配");
			CodeErrorDictionary.Add(2604, "设备不在线");
			CodeErrorDictionary.Add(2605, "流媒体向设备发送或接受信令超时 / cas响应超时");
			CodeErrorDictionary.Add(2606, "token失效");
			CodeErrorDictionary.Add(2607, "客户端的URL格式错误");
			CodeErrorDictionary.Add(2609, "预览开启隐私保护");
			CodeErrorDictionary.Add(2610, "设备达到最大连接数");
			CodeErrorDictionary.Add(2611, "token无权限");
			CodeErrorDictionary.Add(2612, "session不存在");
			CodeErrorDictionary.Add(2613, "验证token的其他异常（不具体）");
			CodeErrorDictionary.Add(2615, "设备通道错");
			CodeErrorDictionary.Add(2651, "设备不支持的码流类型");
			CodeErrorDictionary.Add(2652, "设备连接预览流媒体服务器失败");
			CodeErrorDictionary.Add(2654, "视频分享时间已经结束");
			CodeErrorDictionary.Add(2691, "相同请求正在处理，拒绝本次处理");
			CodeErrorDictionary.Add(2700, "流媒体服务器内部处理错误");
			CodeErrorDictionary.Add(2703, "vtm分配vtdu服务器失败");
			CodeErrorDictionary.Add(2744, "设备返回无视频源");
			CodeErrorDictionary.Add(2745, "视频分享时间已经结束");
			CodeErrorDictionary.Add(2746, "VTDU取流并发2路限制");
			CodeErrorDictionary.Add(2756, "ticket校验失败");
			CodeErrorDictionary.Add(3001, "未知错误");
			CodeErrorDictionary.Add(3002, "报文参数错误");
			CodeErrorDictionary.Add(3003, "报文解析错误");
			CodeErrorDictionary.Add(3006, "非法命令");
			CodeErrorDictionary.Add(3007, "过时命令");
			CodeErrorDictionary.Add(3008, "错误命令");
			CodeErrorDictionary.Add(3011, "校验码错误");
			CodeErrorDictionary.Add(3016, "协议版本错误");
			CodeErrorDictionary.Add(3017, "协议版本过低");
			CodeErrorDictionary.Add(3018, "协议版本被禁止");
			CodeErrorDictionary.Add(3021, "序列号解析失败");
			CodeErrorDictionary.Add(3022, "序列号被禁止");
			CodeErrorDictionary.Add(3023, "序列号重复");
			CodeErrorDictionary.Add(3024, "相同序列号短时间内大量重复请求");
			CodeErrorDictionary.Add(3025, "序列号不再支持");
			CodeErrorDictionary.Add(3031, "本地无法响应");
			CodeErrorDictionary.Add(3032, "本地主动拒绝");
			CodeErrorDictionary.Add(3033, "无法接受请求");
			CodeErrorDictionary.Add(3034, "设备加密算法不匹配");
			CodeErrorDictionary.Add(3036, "设备类型错误");
			CodeErrorDictionary.Add(3037, "设备类型不再支持");
			CodeErrorDictionary.Add(3041, "设备无法响应");
			CodeErrorDictionary.Add(3042, "操作码错误");
			CodeErrorDictionary.Add(3043, "设备或平台未找到对应的加密算法");
			CodeErrorDictionary.Add(3044, "拒绝");
			CodeErrorDictionary.Add(3045, "没有可用资源,设备连接上线");
			CodeErrorDictionary.Add(3046, "通道错");
			CodeErrorDictionary.Add(3047, "不支持的命令");
			CodeErrorDictionary.Add(3048, "没有权限");
			CodeErrorDictionary.Add(3049, "没有找到会话");
			CodeErrorDictionary.Add(3051, "该通道已在发流");
			CodeErrorDictionary.Add(3052, "取流地址重复");
			CodeErrorDictionary.Add(3053, "不支持的码流类型");
			CodeErrorDictionary.Add(3054, "不支持的传输方式");
			CodeErrorDictionary.Add(3055, "连接预览流媒体服务器失败");
			CodeErrorDictionary.Add(3056, "查询设备公网出口地址失败");
			CodeErrorDictionary.Add(3061, "查找录像开始时间错");
			CodeErrorDictionary.Add(3062, "查找录像结束时间错");
			CodeErrorDictionary.Add(3063, "查找录像失败");
			CodeErrorDictionary.Add(3066, "不支持的回放类型");
			CodeErrorDictionary.Add(3067, "没有找到文件");
			CodeErrorDictionary.Add(3068, "开始时间错误");
			CodeErrorDictionary.Add(3069, "错误的结束时间");
			CodeErrorDictionary.Add(3070, "该时间段内没有录像");
			CodeErrorDictionary.Add(3071, "连接回放服务器端失败");
			CodeErrorDictionary.Add(3076, "不支持的语音编码类型");
			CodeErrorDictionary.Add(3077, "该通道已在对讲");
			CodeErrorDictionary.Add(3078, "和目的地址已有链接");
			CodeErrorDictionary.Add(3079, "not support talk");
			CodeErrorDictionary.Add(3080, "通道号错误");
			CodeErrorDictionary.Add(3081, "连接语音服务器失败");
			CodeErrorDictionary.Add(3082, "设备拒绝");
			CodeErrorDictionary.Add(3083, "设备资源受限");
			CodeErrorDictionary.Add(3086, "没有本地存储");
			CodeErrorDictionary.Add(3087, "正在格式化中");
			CodeErrorDictionary.Add(3088, "尝试格式化失败");
			CodeErrorDictionary.Add(3091, "服务器拒绝设备升级请求");
			CodeErrorDictionary.Add(3092, "没有找到请求版本");
			CodeErrorDictionary.Add(3093, "不需要升级");
			CodeErrorDictionary.Add(3094, "没有升级服务器在线");
			CodeErrorDictionary.Add(3095, "所有升级服务器都达到最大负载");
			CodeErrorDictionary.Add(3101, "正在软件升级");
			CodeErrorDictionary.Add(3102, "升级失败（包含未知错误）");
			CodeErrorDictionary.Add(3103, "升级写Flash失败");
			CodeErrorDictionary.Add(3104, "升级语言不匹配");
			CodeErrorDictionary.Add(3106, "密码更新失败，没有对应用户");
			CodeErrorDictionary.Add(3107, "密码跟新失败，原始密码错误");
			CodeErrorDictionary.Add(3108, "密码更新失败，新密码解密失败");
			CodeErrorDictionary.Add(3109, "密码更新失败，新密码不符合规则");
			CodeErrorDictionary.Add(3110, "更新密码失败，写flash失败");
			CodeErrorDictionary.Add(3111, "更新密码失败，其他原因");
			CodeErrorDictionary.Add(3116, "验证密码失败");
			CodeErrorDictionary.Add(3121, "请求的设备不在线");
			CodeErrorDictionary.Add(3122, "为了保护设备，拒绝请求");
			CodeErrorDictionary.Add(3123, "设备达到链接的客户端上限");
			CodeErrorDictionary.Add(3124, "要求客户端断开与设备连接");
			CodeErrorDictionary.Add(3125, "设备拒绝平台发送的客户端连接请求");
			CodeErrorDictionary.Add(3126, "CAS向验证中心验证用户权限失败");
			CodeErrorDictionary.Add(3127, "设备开启隐私保护");
			CodeErrorDictionary.Add(3128, "没有关联特征码");
			CodeErrorDictionary.Add(3131, "不支持的布撤防类型");
			CodeErrorDictionary.Add(3132, "布撤防失败");
			CodeErrorDictionary.Add(3133, "强制布撤防失败");
			CodeErrorDictionary.Add(3134, "需要强制布撤防");
			CodeErrorDictionary.Add(3141, "没有找到云存储服务器");
			CodeErrorDictionary.Add(3142, "用户未开通云存储");
			CodeErrorDictionary.Add(3145, "文件已到结尾");
			CodeErrorDictionary.Add(3146, "无效的session");
			CodeErrorDictionary.Add(3147, "无效的文件");
			CodeErrorDictionary.Add(3148, "未知的云存储类型");
			CodeErrorDictionary.Add(3149, "不支持的文件类型");
			CodeErrorDictionary.Add(3150, "无效的文件");
			CodeErrorDictionary.Add(3151, "配额已满");
			CodeErrorDictionary.Add(3152, "文件已满");
			CodeErrorDictionary.Add(3200, "客户端错误号");
			CodeErrorDictionary.Add(3201, "参数错误");
			CodeErrorDictionary.Add(3202, "分配资源失败");
			CodeErrorDictionary.Add(3203, "发送错误");
			CodeErrorDictionary.Add(3204, "接收错误");
			CodeErrorDictionary.Add(3205, "解析报文错误");
			CodeErrorDictionary.Add(3206, "生成报文错误");
			CodeErrorDictionary.Add(3207, "初始化Socket失败");
			CodeErrorDictionary.Add(3208, "创建socket失败");
			CodeErrorDictionary.Add(3209, "连接服务器失败");
			CodeErrorDictionary.Add(3210, "CASLIB.dll not init");
			CodeErrorDictionary.Add(3211, "超过CASCLIENT库支持的最大数");
			CodeErrorDictionary.Add(3212, "信令发送超时");
			CodeErrorDictionary.Add(3213, "信令接收超时");
			CodeErrorDictionary.Add(3214, "create data packet failed");
			CodeErrorDictionary.Add(3215, "解析数据包错误");
			CodeErrorDictionary.Add(3216, "用户中途强行退出");
			CodeErrorDictionary.Add(3217, "获取本地端口错误");
			CodeErrorDictionary.Add(3218, "base64编码出错");
			CodeErrorDictionary.Add(3219, "base64 decode failed");
			CodeErrorDictionary.Add(3220, "接收数据错误");
			CodeErrorDictionary.Add(3221, "AES加密出错");
			CodeErrorDictionary.Add(3222, "AES解密出错");
			CodeErrorDictionary.Add(3223, "不支持的操作");
			CodeErrorDictionary.Add(3224, "p2p打洞失败");
			CodeErrorDictionary.Add(3225, "发送打洞包失败");
			CodeErrorDictionary.Add(3228, "初始化ssl失败");
			CodeErrorDictionary.Add(3229, "ssl连接失败");
			CodeErrorDictionary.Add(3249, "认证的其他错误");
			CodeErrorDictionary.Add(3250, "认证的数据库错误");
			CodeErrorDictionary.Add(3251, "认证的参数错误");
			CodeErrorDictionary.Add(3252, "认证的执行异常");
			CodeErrorDictionary.Add(3253, "认证的session不正常");
			CodeErrorDictionary.Add(3254, "认证的缓存异常");
			CodeErrorDictionary.Add(3255, "认证的无权限");
			CodeErrorDictionary.Add(3290, "没有可用的P2P预链接，和之前最大连接数（3045）做个区分");
			CodeErrorDictionary.Add(3291, "三路直连 / P2P之后，第四路直连设备返回的错误码");
			CodeErrorDictionary.Add(3292, "没有P2P取流资源, 直连资源有余");
			#endregion
